...
class OnboardingController(http.Controller):
    ...
    @http.route('/registro/account_invoice_onboarding', auth='user', type='json')
    def account_invoice_onboarding(self):
        ...
        return {
            'html': request.env.ref('registro.account_invoice_onboarding_panel').render({
                'company': company,
                'state': company.get_and_update_account_invoice_onboarding_state()
            })
        }

    @http.route('/registro/account_dashboard_onboarding', auth='user', type='json')
    def account_dashboard_onboarding(self):
        ...
        return {
            'html': request.env.ref('registro.account_dashboard_onboarding_panel').render({
                'company': company,
