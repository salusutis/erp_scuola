...
class account_journal(models.Model):
    ...
    def action_create_new(self):
        ...
        if self.type == 'sale':
            ...
            view_id = self.env.ref('registro.invoice_form').id
            ...
            view_id = self.env.ref('registro.view_move_form').id
            model = 'account.move'
        return {
    ...
    def open_payments_action(self, payment_type, mode='tree'):
        if payment_type == 'outbound':
            action_ref = 'registro.action_account_payments_payable'
        elif payment_type == 'transfer':
            action_ref = 'registro.action_account_payments_transfer'
        else:
            action_ref = 'registro.action_account_payments'
    ...
    def create_bank_statement(self):
        ...
        action = self.env.ref('registro.action_bank_statement_tree').read()[0]
        action.update({
            'views': [[False, 'form']],
